...
namespace wordSearch.Tests
{
  ...
  public class RepeatCounterTest
  {
    ...
    [TestMethod]
    public void IsRepeatCounter_FoundOneLorem_False()
    {
      Assert.AreEqual(false, RepeatCounter.returnTest3("Lorem ipsum dolor sit amet, consectetuer adipiscing elit."));
    }
  }
}
